...
// Determine where the logo should link to based on user role
$logoLink = $basePath; // Default to home/login page
if (isset($_SESSION['role'])) {
    if ($_SESSION['role'] === 'admin') {
        $logoLink = $basePath . 'admin/dashboard.php';
    } elseif ($_SESSION['role'] === 'waiter') {
        $logoLink = $basePath . 'waiter/index.php';
    } elseif ($_SESSION['role'] === 'chef') {
        $logoLink = $basePath . 'chef/dashboard.php';
    }
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <header class="main-header">
        <div class="header-content">
            <a href="<?php echo htmlspecialchars($logoLink); ?>" class="logo">Yobita</a>
                ...
                <ul>
                    ...
                    <?php if (isset($_SESSION['user_id'])) : ?>
                        ...
                        <li class="profile-nav-item">
                            <a href="javascript:void(0)" class="profile-link <?php echo ($pageTitle === 'Profile') ? 'active' : ''; ?>" style="cursor: default;">
                                <!-- Show profile pic -->
