...
<head>
    ...
    <header class="main-header">
        <div class="header-content">
            <a href="<?php echo $basePath; ?>staff/index.php" class="logo">Yobita</a>
            
            <nav class="main-nav">
                <ul>
                    <!-- ===== STAFF-SPECIFIC LINKS ===== -->
                    <?php if (isset($_SESSION['role']) && $_SESSION['role'] === 'staff') : ?>
                        <li><a href="<?php echo $basePath; ?>staff/index.php" class="<?php echo ($pageTitle === 'Dashboard') ? 'active' : ''; ?>">Dashboard</a></li>
                        <li><a href="#" class="<?php echo ($pageTitle === 'Active Orders') ? 'active' : ''; ?>">Active Orders</a></li>
                    <?php endif; ?>
