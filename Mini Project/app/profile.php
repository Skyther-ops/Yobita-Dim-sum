...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    // --- 1. VERIFY CAPTCHA ---
    if (!isset($_POST['captcha']) || intval($_POST['captcha']) !== $_SESSION['captcha']) {
...
<div class="profile-container">
    ...
    <form action="profile.php" method="post" id="profile-form">
        ...
        <div class="pfp-section">
            <img src="<?php echo htmlspecialchars($user['profile_picture']); ?>" alt="Profile Picture" id="pfp-preview">
            <label for="pfp-upload" class="pfp-upload-btn">Change Picture</label>
        ...
        <div class="form-group captcha-group">
            <label for="captcha">Security Check: What is <?php echo $num1; ?> + <?php echo $num2; ?>?</label>
